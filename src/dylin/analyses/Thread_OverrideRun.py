# ============================== Define spec ==============================
"""
Module for Thread_OverrideRun functionality.
"""
...
class Thread_OverrideRun(BaseDyLinAnalysis):
    """
Thread overriderun: logical component class.
"""
...
Key Variables:
    ...
    original_run_method_hash: Local state member.
    source_code: Local state member.
...
Key Variables:
    ...
    obj: Local state member.
    sha: Local state member.
